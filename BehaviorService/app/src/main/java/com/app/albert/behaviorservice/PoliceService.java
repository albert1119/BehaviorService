...
public class PoliceService extends Service
{
    ...
    public void onCreate()
    {
        ...
        Toast.makeText(getApplicationContext(), "PoliceService OnCreate", Toast.LENGTH_SHORT).show();
    }
    ...
    private Runnable CheckService = new Runnable() {
        public void run()
        {
            if(CheckAPP("com.app.albert.servicemanager") == false)
            {
                Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.app.albert.servicemanager");
            ...
            if(MainActivity.isServiceRunning(mContext, "BehaviorService") == false)
            {
                Intent serviceIntent = new Intent(mContext, BehaviorService.class);
